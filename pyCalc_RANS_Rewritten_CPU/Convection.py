...
def Convection(ap2d_vel, u2d, v2d, p2d, uface_w, uface_s, vface_w, vface_s, uBC_e, uBC_w, uBC_n, uBC_s, uBC_Types, vBC_e, vBC_w, vBC_n, vBC_s, \
               vBC_Types, ni, nj, fx, fy, dir_area_wx, dir_area_wy, dir_area_sx, dir_area_sy, F_area_w, F_area_s):
